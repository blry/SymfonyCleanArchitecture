...
use App\Application\User\UseCase\Me\ChangePassword\Input;
...
class Controller extends BaseController
{
    ...
    #[OA\RequestBody(
        description: 'Payload',
        content: new Model(type: ChangePasswordBody::class)
    )]
    #[OA\Response(
        response: 200,
        description: 'Success',
    ...
    #[Route('/user/v1/me/password', name: 'user.v1.me.password', methods: ['POST'])]
    #[IsGranted('IS_AUTHENTICATED_FULLY', message: 'You must be logged in.')]
    public function __invoke(
        #[MapRequestPayload] ChangePasswordBody $dto,
        #[CurrentUser] UserInterface $user
    ): Response
    {
        $this->dispatchMessage(new Input($user->getUserIdentifier(), $dto->oldPassword, $dto->newPassword));
